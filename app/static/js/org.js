...
function genContent(d) {
  /*
    Node content needs to be normal CSS for PNG and SVG 
    exports to work.
    DO NOT CHANGE NODE CONTENT TO TAILWIND CSS

    Also, the data attibutes (d.data.id, etc.) need to 
    match the column names in the models.py fiel exactly
  ...
  */
  ...
  d.width
      ...
      <div class="node-salaries" style="color:#716E7B;margin-left:20px;margin-top:3px;font-size:10px;display:${salaryHidden ? 'none' : 'block'};"> ${
