              ...
              <div style="font-family: 'Inter', sans-serif;background-color:${color};  margin-left:-1px;width:${d.width - 2}px;height:${d.height - imageDiffVert}px;border-radius:10px;border: ${d.data._highlighted || d.data._upToTheRootHighlighted ? '5px solid #0000FF"' : '1px solid #E4E2E9"'} >
                  ...
                  <div class="node-salaries" style="color:#716E7B;margin-left:20px;margin-top:3px;font-size:10px;"> ${
                   ...
                   <div style="display:flex;justify-content:space-between;padding-left:15px;padding-right:15px;">
                        <div style="position: absolute; bottom: 10px; left: 15px;" class="node-direct-reports">Directs: ${
                          d.data._directSubordinates
                        } </div>  
                        <div style="position: absolute; bottom: 10px; right: 15px;" class="node-total-reports">Total: ${
